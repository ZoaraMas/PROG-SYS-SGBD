...
public class MyResultSet implements ResultSet, Serializable{
    ...
    public MyResultSet(Object[][] data) {
        this.data = data;
    }
    ...
    public String getString(int columnIndex) throws SQLException {
        if(data[currentRow][columnIndex - 1] == null) return "null"; 
        return data[currentRow][columnIndex - 1].toString();
    }
    ...
    public int getInt(int columnIndex) throws SQLException {
        if(data[currentRow][columnIndex - 1] == null) return 0; 
        Object o = data[currentRow][columnIndex - 1];
        return (int)o;
    }
